...
bui4_blood_unit_weight: String,
bui5_weight_units: String,
bui6_blood_unit_volume: String,
bui7_volume_units: String,
bui8_container_catalog_number: String,
bui9_container_lot_number: String,
